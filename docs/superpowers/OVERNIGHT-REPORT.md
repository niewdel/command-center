...
[04:29 EDT] Portal hardening landed (d2441c9): size precheck + file cap + magic-byte sniff + generic errors. Caught+fixed a regression it introduced — HEIC/HEIF (iPhone) uploads were being 415-rejected; added ftyp/HEIC-brand detection (9172cbe), green. All 4 PRs reviewed + green. Overnight build complete.
